class Api::V1::ActiveTimersController < ApplicationController
  ...
  def create
    ...
    TimerWorker.perform_async(new_timer.id, new_timer.user_id, new_timer.duration, new_timer.create_body(body_params.merge(image_url))) 
  ...
  def body_params
    params.permit(:substance, :dosage, :entry_instructions, :notes, :status, :address)
  end 
end
